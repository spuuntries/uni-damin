...
def explore_videos(driver, video_urls, depth, max_depth, json_file):
    ...
    for video_url in video_urls:
        ...
        try:
            ...
            video_data = {"title": title, "href": video_url}
            ...
            try:
                ...
                video_data["desc"] = parsed.select_one(
            ...
            try:
                ...
                video_data["likes"] = parsed.select_one(
            ...
            try:
                ...
                video_data["duration"] = parsed.select_one(
                    ".ytp-time-duration"
                ).text  # type: ignore
            ...
            try:
                ...
                video_data["channelName"] = parsed.select_one(
                    ".ytd-channel-name a",
                ).text  # type: ignore
            ...
            try:
                ...
                video_data["subCount"] = parsed.select_one(
                    "#owner-sub-count"
                ).text  # type: ignore
            ...
            try:
                ...
                if len(date_views) > 1:
                    video_data["viewCount"] = date_views[0]
                video_data["uploadDate"] = date_views[-1]
            ...
            json_file.write(json.dumps(video_data) + "\n")
            json_file.flush()
            ...
            explore_videos(driver, related_video_urls, depth + 1, max_depth, json_file)
...
with webdriver.Chrome(options=options, version_main=127) as driver:
    try:
        ...
        try:
            ...
            json_filename = f"ytResults_{len(list(filter(lambda x: 'ytResults' in x, os.listdir(os.getcwd())))) + 1}_{uuid4()}.json"
            with open(json_filename, "w") as json_file:
                explore_videos(driver, initial_video_urls, 0, max_depth, json_file)

            logger(f"In total, we extracted {processed_count} video metadatas.", processed_count)
